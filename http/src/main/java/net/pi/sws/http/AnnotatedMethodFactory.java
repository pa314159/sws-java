...
final class AnnotatedMethodFactory
implements ClassPathScanner.Visitor, MethodFactory<HttpServiceFactory>
{

	static private final ExtLog					L			= ExtLog.get();

	private static final AnnotatedMethodFactory	INSTANCE	= new AnnotatedMethodFactory();
	...
	static public AnnotatedMethodFactory getInstance()
	{
		return INSTANCE;
	}
	...
	private AnnotatedMethodFactory()
	{
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.pi.sws.http.MethodFactory#get(java.lang.String, net.pi.sws.http.HttpServiceFactory,
	 *      net.pi.sws.http.HttpRequest, net.pi.sws.http.HttpResponse)
	 */
