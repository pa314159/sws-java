...
public class DeflaterChannelOutputTest
{
	...
	public DeflaterChannelOutputTest( int chunks )
	{
		this.chunks = chunks;
	}
	...
	public void run1() throws IOException
	{
		...
		for( int k = 0; k < this.chunks; k++ ) {
			...
			final DeflaterChannelOutput dco = new DeflaterChannelOutput( Channels.newChannel( result ) );
	...
	public void run2() throws IOException
	{
		...
		for( int k = 0; k < this.chunks; k++ ) {
			...
			final DeflaterChannelOutput dco = new DeflaterChannelOutput( Channels.newChannel( result ), def2 );
	...
	public void run3() throws IOException
	{
		...
		for( int k = 0; k < this.chunks; k++ ) {
			...
			final Deflater def2 = new Deflater( 9 );
			final DeflaterChannelOutput dco = new DeflaterChannelOutput( Channels.newChannel( result ), def2, 2048 );
